...
<div class="para_search_met_16_1" m-id='<?php echo $ui['mid'];?>'>
...
<main class="product_list_page_met_11_1" m-id='<?php echo $ui['mid'];?>'>
    <div class="container">
    <!-- sidebar -->
    ...
    <!-- 内容 -->
        ...
        <ul class="product_list_page_met_11_1-list blocks     <?php if($ui['column_xs']==1){ ?>
        blocks-100
        <?php }else{ ?>
...
<!--展示内容-->
    ...
    <!--标准-->
                            <li class='p-r-15  item' >
                                <div class="card ">
                                    <figure class="overlay overlay-hover">
                                    <img class="overlay-figure" src="<?php echo thumb($p['imgurl'],$c['met_productimg_x'],$c['met_productimg_y']);?>" alt="<?php echo $p['title'];?>">
                                    <a href="<?php echo $p['url'];?>" <?php echo $g['urlnew'];?> class="overlay-panel overlay-background overlay-fade overlay-icon">
                                      <i class="fa fa-search"></i>
                                    </a>
                                    </figure>
                                    <h4 class="card-title p-y-20 font-szie-16 ">
                                        <a href="<?php echo $p['url'];?>" title="<?php echo $p['title'];?>" class="block text-truncate" <?php echo $g['urlnew'];?>><?php echo $p['title'];?></a>
                                        <p class="keyword"><?php echo $p['keywords'];?></p>
                                        <p class="price m-b-0 m-t-5"><?php echo $p['price_str'];?></p>
                                    </h4>
                                </div>
                            </li>
<!--标准-->
...
<!--橱窗-->
            ...
            ?>
                                ...
                                <a href="<?php echo $p['url'];?>" title="<?php echo $p['title'];?>" class="btn btn-default" <?php echo $g['urlnew'];?>><?php echo $word['Detail'];?></a>
                                </h4>
                            </div>
                            </li>
<!--橱窗-->
