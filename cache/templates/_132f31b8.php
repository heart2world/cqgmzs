...
<?php } ?>
        ...
        <?php
            ...
            ?>
<?php defined('IN_MET') or exit('No permission');?>
<div class="about_list_met_21_9 met-index-product met-index-body met-index-newproduct"
 ...
 m-id='<?php echo $ui['mid'];?>'>
    <div class="container">
        ...
        <?php
            ...
            $ui['has'] =$ui_compile->list_page_config($met_page);
            ?>
<div class="img_list_met_36_2 met-index-body" m-id="<?php echo $ui['mid'];?>" >
	<div class="
			    <?php if($ui[is_full]==1){ ?>
...
?>
        ...
        <?php
            ...
            $ui['has'] =$ui_compile->list_page_config($met_page);
            ?>
<section class="about_list_met_28_4 text-xs-center"  m-id="<?php echo $ui['mid'];?>">
    <div class="container">
        <div class="navbg">
            <ul class="imglist" >
                <?php
...
?>
        ...
        <?php
            ...
            $ui['has'] =$ui_compile->list_page_config($met_page);
            ?>
<div class="product_list_met_35_6 met-index-body" m-id='<?php echo $ui['mid'];?>'>
...
?>
        ...
        <?php
            ...
            $ui['has'] =$ui_compile->list_page_config($met_page);
            ?>
<div class="news_list_met_16_2 met-index-body     <?php if($ui['bg_type']){ ?>bgcolor<?php }else{ ?>bgpic<?php } ?>" m-id='<?php echo $ui['mid'];?>'>
	<div class="container">
