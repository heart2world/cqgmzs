...
<?php } ?>
        ...
        <?php
            ...
            $ui['has'] =$ui_compile->list_page_config($met_page);
            ?>
<section class="404_met_16_1 page404">
    <div class="container text-xs-center box404 h-500 vertical-align">
        <h4 class="size404 font-size-50 vertical-align-middle"><?php echo $word['error404'];?></h4>
    </div>
</section>
